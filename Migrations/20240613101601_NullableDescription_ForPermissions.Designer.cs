...
namespace ForestChurches.Migrations
{
    ...
    [Migration("20240613101601_NullableDescription_ForPermissions")]
    partial class NullableDescription_ForPermissions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ForestChurches.Models.RolePermission", b =>
                {
                    ...
                    b.HasOne("ForestChurches.Areas.Identity.Data.ChurchRoles", "Role")
                        .WithMany("RolePermissions")
