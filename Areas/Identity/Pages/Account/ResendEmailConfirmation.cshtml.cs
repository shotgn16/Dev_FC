...
namespace ForestChurches.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<ChurchAccount> userManager, iEmail emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _emailSender.StartEmailAsync(Input.Email, userData, "Confirm your email", "./templates/confirm_email.html");
