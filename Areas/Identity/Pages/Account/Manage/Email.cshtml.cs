...
namespace ForestChurches.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public EmailModel(
            ...
            iMailSender mailSender, ForestChurchesContext context)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                // Send Email
                _mailSender.SendEmailConfirmAccount(Guid.Parse(_userManager.GetUserId(User)), _userManager.GetUserName(User), "/Account");
