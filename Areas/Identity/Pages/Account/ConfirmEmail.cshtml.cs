...
namespace ForestChurches.Areas.Identity.Pages.Account
{
    public class ConfirmEmailModel : PageModel
    {
        ...
        public ConfirmEmailModel(UserManager<ChurchAccount> userManager, iMailSender mailSender)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string code)
        {
            ...
            // Send Email
            _mailSender.SendEmailRegisteredUser(Guid.Parse(_userManager.GetUserId(User)), _userManager.GetUserName(User), "/Account");
